function [conf] = confusionNN(feature_all, all_feature, trmx, taxas, cl_method, TNET, TP, PN, training_options)
...
%This matrix should be solely based on NN classiication
