...
m=m(:,1:size(m,2)-1);%gets rid of lf in last column.

disp([num2str([1:numfile]'),blanks(numfile)',m]);
start_file = input('Starting file number from above list: ');
...
d
        ...
        [xwid, ywid, imrow, imcol, btnarea, d_imfile]= supervisbin2(imfiles, domain, 1,disc);
